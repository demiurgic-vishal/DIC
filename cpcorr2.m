function xyinput = cpcorr2(varargin)
...
[xyinput_in,xybase_in,input,base,CORRSIZE] = ParseInputs(varargin{:});
...
%-------------------------------
%
function [xyinput_in,xybase_in,input,base,CORRSIZE] = ParseInputs(varargin)
